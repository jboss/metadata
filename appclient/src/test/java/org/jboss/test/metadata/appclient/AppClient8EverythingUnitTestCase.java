...
/**
 * App Client 8 everything test.
 *
 * @author Eduardo Martins
 *
 */
public class AppClient8EverythingUnitTestCase extends AbstractJavaEEEverythingTest {
    ...
    protected void assertEnvironment(String prefix, AppClientEnvironmentRefsGroupMetaData env) {
        ...
        final JavaEEVersion javaEEVersion = JavaEEVersion.V8;
