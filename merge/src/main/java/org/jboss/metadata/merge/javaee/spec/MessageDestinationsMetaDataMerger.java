...
public class MessageDestinationsMetaDataMerger {
    ...
    public static void merge(MessageDestinationsMetaData dest, MessageDestinationsMetaData override, MessageDestinationsMetaData original) {
        MergeUtil.merge(dest, override, original);
    }

    public static void augment(MessageDestinationsMetaData dest, MessageDestinationsMetaData augment, MessageDestinationsMetaData main, boolean resolveConflicts) {
        for (MessageDestinationMetaData messageDestinationMetaData : augment) {
            if (dest.containsKey(messageDestinationMetaData.getKey())) {
                dest.get(messageDestinationMetaData.getKey()).augment(messageDestinationMetaData,
