...
public class AnnotatedEJBReferencesMetaDataMerger {
    ...
    public static void augment(AnnotatedEJBReferencesMetaData dest, AnnotatedEJBReferencesMetaData augment, AnnotatedEJBReferencesMetaData main, boolean resolveConflicts) {
        for (AnnotatedEJBReferenceMetaData ejbReference : augment) {
            if (dest.containsKey(ejbReference.getKey())) {
                if (!resolveConflicts && (main == null || !main.containsKey(ejbReference.getKey()))) {
                    ...
                    dest.get(ejbReference.getKey()).augment(ejbReference, (main != null) ? main.get(ejbReference.getKey()) : null,
                            resolveConflicts);
                }
            } else {
