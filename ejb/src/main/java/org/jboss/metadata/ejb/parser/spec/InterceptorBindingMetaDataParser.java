...
public class InterceptorBindingMetaDataParser extends AbstractMetaDataParser<InterceptorBindingMetaData>
{
   ...
   @Override
   public InterceptorBindingMetaData parse(XMLStreamReader reader) throws XMLStreamException
   {
      InterceptorBindingMetaData interceptorBinding = new InterceptorBindingMetaData();
      this.processElements(interceptorBinding, reader);
      return interceptorBinding;
   }

   @Override
   protected void processElement(InterceptorBindingMetaData interceptorBinding, XMLStreamReader reader) throws XMLStreamException
   {
